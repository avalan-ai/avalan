...
class VendorBuildToolCallTextTestCase(TestCase):
    ...
    def test_build_tool_call_text_from_string_json(self) -> None:
    ...
    def test_build_tool_call_text_preserves_plain_provider_name(self) -> None:
        text = TextGenerationVendor.build_tool_call_text(
            call_id="1",
            tool_name="pkg__tool",
            arguments='{"a": 1}',
    ...
    def test_build_tool_call_text_keeps_executable_boundary(
        ...
        payload = loads(
            text.removeprefix("<tool_call>").removesuffix("</tool_call>")
        )
        self.assertEqual(
            payload,
    ...
    def test_build_tool_call_text_preserves_malformed_encoded_name(
        self,
    ) -> None:
        text = TextGenerationVendor.build_tool_call_text(
            call_id="call-1",
    ...
    def test_build_tool_call_text_handles_invalid_json_str(self) -> None:
        text = TextGenerationVendor.build_tool_call_text(
            call_id=None,
            tool_name="tool",
            arguments='{"a": }',
    ...
    def test_build_tool_call_text_uses_empty_object_for_non_object_json(
        self,
    ) -> None:
    ...
    def test_build_tool_call_text_keeps_empty_object_arguments_valid(
        self,
    ) -> None:
        text = TextGenerationVendor.build_tool_call_text(
            call_id="call-1",
    ...
    def test_build_tool_call_text_from_dict(self) -> None:
        text = TextGenerationVendor.build_tool_call_text(
            call_id="2",
            tool_name=None,
            arguments={"b": 2},
    ...
    def test_build_tool_call_text_preserves_object_call_id(self) -> None:
        call_id = uuid4()
        text = TextGenerationVendor.build_tool_call_text(
            call_id=call_id,
            tool_name="tool",
    ...
    def test_build_tool_call_text_rejects_invalid_provider_name(self) -> None:
        with self.assertRaises(AssertionError):
