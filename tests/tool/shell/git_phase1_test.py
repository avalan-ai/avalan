...
_GIT_TOOL_ARGUMENTS: dict[str, dict[str, object]] = {
    ...
    "git_switch": _git_kwargs(branch="feature", create=True),
    ...
    "git_stash_apply": _git_kwargs(stash="stash@{1}", index=True),
    "git_commit": _git_kwargs(message="message"),
    "git_branch_create": _git_kwargs(name="feature", start_point="HEAD"),
    "git_branch_delete": _git_kwargs(name="old", force=True),
    "git_branch_rename": _git_kwargs(old_name="old", new_name="new"),
    "git_tag_create": _git_kwargs(
        name="v1.0",
        target="HEAD",
        message="tag",
    ),
    "git_tag_delete": _git_kwargs(name="v0.1"),
    "git_merge": _git_kwargs(revision="feature", mode="no_ff"),
    "git_rebase": _git_kwargs(upstream="main", branch="feature"),
    "git_cherry_pick": _git_kwargs(revision="abc123"),
    "git_revert": _git_kwargs(revision="abc123"),
    ...
    "git_stash_pop": _git_kwargs(stash="stash@{1}", index=True),
    "git_stash_drop": _git_kwargs(stash="stash@{1}"),
