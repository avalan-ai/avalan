...
![Leo Messi petting a cute cat](https://avalan.ai/images/github/tool_math.webp)
...
![Example use of an ephemeral tool agent with memory](https://avalan.ai/images/github/tool_math.webp)
