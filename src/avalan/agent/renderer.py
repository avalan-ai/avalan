...
class Renderer:
    ...
    def from_string(
        ...
        return Template(template).render(**template_vars).encode(encoding) \
               if template_vars else template
