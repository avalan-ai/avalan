...
try:  # pragma: no cover - litellm might not be installed
    import litellm
except Exception:  # pragma: no cover - litellm might not be installed
    litellm = None
...
class LiteLLMClient(TextGenerationVendor):
    ...
    def __init__(
        ...
        assert litellm, "litellm is not available"
